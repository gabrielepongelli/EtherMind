 ...
 * 5. GAME_STARTED: the game is actually started.
 * 6. ROUND_PLAYING: one of the rounds is taking place.
...
Phase constant GAME_STARTED = Phase.wrap(1 << 3);
Phase constant ROUND_PLAYING = Phase.wrap(1 << 4);
Phase constant ROUND_END = Phase.wrap(1 << 5);
Phase constant GAME_END = Phase.wrap(1 << 6);
